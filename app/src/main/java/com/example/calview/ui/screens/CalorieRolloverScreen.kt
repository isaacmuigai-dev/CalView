    ...
    OnboardingTemplate(
        ...
        Column(
            ...
            Column {
                SuggestionChip(
                    onClick = { },
                    label = { Text("Rollover up to 200 cals", color = Color(0xFF6A8FB3), fontFamily = FontFamily.SansSerif) },
        ...
        Column {
            ...
            Column(modifier = Modifier.padding(16.dp), horizontalAlignment = Alignment.CenterHorizontally) {
                Row(verticalAlignment = Alignment.Bottom) {
                    Text(calories.toString(), fontSize = 28.sp, fontWeight = FontWeight.Bold, fontFamily = FontFamily.SansSerif)
                    Text("/$total", fontSize = 16.sp, color = Color.Gray, modifier = Modifier.padding(bottom = 4.dp), fontFamily = FontFamily.SansSerif)
                }
                ...
                Box(contentAlignment = Alignment.Center, modifier = Modifier.size(80.dp)) {
                    ...
                    Column(
                        ...
                        Text("Cals left", fontSize = 8.sp, color = Color.White, fontFamily = FontFamily.SansSerif)
                        Text(if (extra != null) "$calories + $extra" else left.toString(), fontSize = 8.sp, color = Color.White, fontWeight = FontWeight.Bold, fontFamily = FontFamily.SansSerif)
                    }
                }
            }
        }
...
@Composable
fun CalorieRolloverScreenPreview() {
    CalViewTheme {
