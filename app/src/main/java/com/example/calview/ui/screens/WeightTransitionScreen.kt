        ...
        CalAICard {
            Column(modifier = Modifier.padding(8.dp)) {
                ...
                Row(
                    ...
                    Text("3 Days", fontSize = 14.sp, color = Color.Black, fontWeight = FontWeight.Medium, fontFamily = FontFamily.SansSerif)
                    Text("7 Days", fontSize = 14.sp, color = Color.Black, fontWeight = FontWeight.Medium, fontFamily = FontFamily.SansSerif)
                    Text("30 Days", fontSize = 14.sp, color = Color.Black, fontWeight = FontWeight.Medium, fontFamily = FontFamily.SansSerif)
                }
...
@Composable
fun WeightTransitionScreenPreview() {
