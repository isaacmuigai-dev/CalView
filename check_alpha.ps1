try {
    ...
    $path = "C:/Users/isaac/.gemini/antigravity/brain/c60fa4b0-2d6d-471c-a85e-f496c98fc074/uploaded_image_1768309617951.png"
    $img = [System.Drawing.Bitmap]::FromFile($path)
    
    $pixel00 = $img.GetPixel(0, 0)
    Write-Host "Pixel(0,0) Alpha: $($pixel00.A)"
    
    # Check another pixel (e.g., top left corner might be transparent, check slightly inside)
